...
LINK32_FLAGS= kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib comctl32.lib advapi32.lib shell32.lib uuid.lib mpr.lib htmlhelp.lib ..\ufreelib\v5subs.lib /nologo /subsystem:windows /incremental:no /machine:I386 /out:"ufree/vtextrac.exe"

RSC_PROJ=/l 0x409 /fo"ufree\vtextrac.res" /d "NDEBUG"

ufree\vtextrac.exe : ufree\vtextrac.obj ufree\vtextrac.res
    link $(LINK32_FLAGS) ufree\vtextrac.obj ufree\vtextrac.res
    copy ufree\vtextrac.exe \v5wide\exes
